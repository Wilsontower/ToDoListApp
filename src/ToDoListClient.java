...
public class ToDoListClient {
    ...
    public void procedure() {
        ...
        try {
            while (true) {
                System.out.println("This is todolit!what do you want following command:");
                    ...
                    case "2":
                        while (true) {
                            if (login()) {
                                ...
                                do {
                                    System.out.println("what do you want following command:");
                                    ...
                                    switch (choice) {
                                        case "1":
                                            System.out.println("please input startTime (yyyy-MM-dd,HH：mm):");
                                            startTime = reader.readLine();
                                            System.out.println("please input endTime (yyyy-MM-dd,HH：mm):");
